                ...
                <div className="row">
                    <div className="col-lg-5 col-md-5 col-6">
                        <div className="header-left d-flex align-items-center">
                            <div className="menu-toggle-btn mr-20" onClick={click}>
                                <button
                                    id="menu-toggle"
                                    className="main-btn primary-btn btn-hover"
                                >
                                    <i className={"lni me-2  "+(active?" lni-menu":" lni-chevron-left")}></i> Menu
                                </button>
                            </div>
                    ...
                    <div className="col-lg-7 col-md-7 col-6">
                        <div className="header-right">
                            ...
                            >
                                ...
                                <li>
                                    <Link to={"/change-password"}><i className="lni lni-cog"></i> Settings </Link>
                                </li>
                                <li>
                                    ...
                                    <a href="#0" onClick={(e)=>{
                                        ...
                                        navigate('/login')
                                    }}> <i className="lni lni-exit"></i> Sign Out </a>
                                </li>
                            </ul>
                            </div>
                            {/* <!-- profile end --> */}
